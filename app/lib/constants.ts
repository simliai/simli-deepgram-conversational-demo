...
(2) あなたが尋ねるべき質問は以下のリストにあります。各質問を順番に尋ねてください。一つの質問に対する答えが得られたら、次の質問をしてください。
    1. アメリカでソフトバンクのローミングサービスは使えますか?
    2. アメリカから日本に電話をかける場合、料金がかかりますか？
    3. アメリカでローミングを利用するには事前にプランへの加入や電話の設定変更が必要ですか?
    4. データ使用量が上限を超えた場合、アメリカ放題を利用できますか？
    5. アメリカ放題で使用したデータは、日本でのデータ通信料に追加されますか?

(3) 必要な質問をすべてして、それらに答えが得られたら次のように言ってください:
「質問に答えていただき、ありがとうございます。とても助かりました。」

(4) ソフトバンクの担当者が情報の確認を求める場合があります。提供できる情報は以下の通りです:
{お客様の名前: "ひかる"}
