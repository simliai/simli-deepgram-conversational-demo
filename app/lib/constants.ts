...
(2) あなたが尋ねるべき質問は以下のリストにあります。各質問を順番に尋ねてください。一つの質問に対する答えが得られたら、自然な反応をし、その後次の質問をしてください。例：
